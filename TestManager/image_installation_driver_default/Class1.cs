...
// 打开现有的Excel工作簿
Excel.Workbook workbook = excelApp.Workbooks.Open(@"c:\TestManager\ItemDownload\SCD_RV07RC.xls");

// 现在您可以在打开的工作簿上执行操作
// Excel.Worksheet worksheet = (Excel.Worksheet)workbook.Worksheets[1]; // 获取第一个工作表
...
// // 創建Excel應用程序對象
//         Excel.Application excelApp = new Excel.Application();
// Runnner.WriteLog("11111111111111111111:");
        
//         // 創建一個新的工作簿
//         Excel.Workbook workbook = excelApp.Workbooks.Add();

// Runnner.WriteLog("2222222222222222222:");

//         Excel.Worksheet worksheet = (Excel.Worksheet)workbook.Worksheets[1];

// Runnner.WriteLog("33333333333333333333333:");
        
//         // 在單元格A1中寫入內容
//         worksheet.Cells[1, 1] = "Hello, Excel from .NET!";
// Runnner.WriteLog("4444444444444444444444444444444444:");
        
//         excelApp.Visible = true;
        
//         // 保存工作簿
//         // workbook.SaveAs("C:\\TestManager\\MyLog\\file.xlsx");
//         workbook.SaveCopyAs("C:\\TestManager\\MyLog\\file.xlsx");
//         // workbook.Save();
// Runnner.WriteLog("555555555555555555555555:");
        
//         // 關閉Excel應用程序
//         excelApp.Quit();
// Runnner.WriteLog("6666666666666666666666666666666:");
        
//         // 釋放COM對象
//         System.Runtime.InteropServices.Marshal.ReleaseComObject(workbook);
//         System.Runtime.InteropServices.Marshal.ReleaseComObject(excelApp);

// Runnner.WriteLog("7777777777777777777777777777777777:");
        
//         Runnner.WriteLog("Excel操作完成。");

}
catch (Exception ex)
{
    Runnner.WriteLog("捕獲到異常:");
    Runnner.WriteLog("異常類型:  " + ex.GetType().Name);
    Runnner.WriteLog("錯誤訊息:  " + ex.Message);
    Runnner.WriteLog("堆疊追蹤:  " + ex.StackTrace);
}
...
//             // 打開Excel檔案
//             Excel.Workbook workbook = excelApp.Workbooks.Open("c:\\TestManager\\SCD_RV07RC.xls");

// Runnner.WriteLog("8888888888888888888888888888888888:");
...
// Runnner.WriteLog("999999999999999999999999999999999999:");
